                    ...
                    <div className="flex wrap">
                        <article className="flex article flex-48">
                            ...
                            <div className="flex-60 article-content">
                                ...
                                <a className="btn btn-tertiary" href="article">Read Article</a>
                            </div>
                        </article>
                        <article className="flex article flex-48">
                            <div className="flex-40 font-0">
                            ...
                            <div className="flex-60 article-content">
                                ...
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                <a className="btn btn-tertiary" href="readmore">Read More</a>
                            </div>
                        </article>
                        <article className="flex article flex-48">
                            <div className="flex-40 font-0">
                            ...
                            <div className="flex-60 article-content">
                                ...
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                <a className="btn btn-tertiary" href="read">Read Article</a>
                            </div>
                        </article>
                        <article className="flex article flex-48">
                            <div className="flex-40 font-0">
                            ...
                            <div className="flex-60 article-content">
                                ...
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                                <a className="btn btn-tertiary" href="view">View Detail</a>
                            </div>
                        </article>
                    </div>
                </div>
